//
//  VendoredInstagramSaveLoginInfoView.swift
//  Instagram clone
//
...
struct VendoredInstagramSaveLoginInfoView: View {
            ...
            VStack {
                ...
                VStack (spacing: 12){
                    NavigationLink(destination: VendoredInstagramRootApp()){
                        VendoredInstagramPrimaryButtonView(title: "Save")
                    }
                    VendoredInstagramPrimaryOutlineButtonView(title: "Not now", action: {
                        dismiss()
                    })
                }
...
#Preview {
    VendoredInstagramSaveLoginInfoView()
}

//
//  VendoredInstagramMessagingDetailView.swift
//  Instagram clone
//
            ...
            ZStack (alignment: .bottom){
                ScrollView {
                    ...
                    VStack {
                        ...
                        // profile header
                        VStack {
                            VendoredInstagramProfileImageView(profileImage: user.profileImage, size: 90)
                            ...
                            VStack (spacing: 3){
                                ...
                                // View profile view
                                VendoredInstagramButtonGrayView(title: "View profile")
                                    .padding(.top, 14)
                                //
                            }
                        }
                        ...
                        VStack (spacing: 5){
                            ...
                            ForEach(messagingData) { item in
                                VendoredInstagramBubbleTextView(text: item.text ,isMe: item.isMe)
                            }
            ...
            .toolbar {
                ToolbarItem (placement: .topBarLeading) {
                    ...
                    HStack {
                        ...
                        HStack (spacing: 10){
                            VendoredInstagramProfileImageView(profileImage: user.profileImage, size: 40)

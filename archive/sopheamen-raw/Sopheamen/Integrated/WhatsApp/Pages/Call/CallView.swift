...
struct CallRecentAllView: View {
    var callAllData:[CallResponse] = callData
    var body: some View {
        ...
        VStack (alignment: .leading, spacing: 6){
            ...
            LazyVStack (spacing: 0){
                ForEach(callAllData) { item in
                    CallProfileView(callResponse: item)
                }
...
struct CallRecentMissedView: View {
    var callAllData:[CallResponse] = callData
    var body: some View {

    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                // content
                VStack {
                    CoverViewAndInfoView(music: music)
                    ButtonsActionView()
                    ProgressBarViewAndPlayView(music: music)
                }
            }
            // remove back button
...
#Preview {
    DetailView(music: musicQuickPicData[9])
}

struct CoverViewAndInfoView:View {
    var music:MusicResponse
    var body: some View {
        VStack {
            // cover
            ...
            VStack (alignment: .leading){
                MarqueeTextView(text: music.name, duration: 20, delay: 1)
                MarqueeTextView(text: music.artistName, font: .subheadline, fontWeight: .regular, boxHeight: 30,duration: 20, delay: 1)
//                Text(music.name)
//                    .font(.title)
//                    .fontWeight(.semibold)
...
struct ProgressBarViewAndPlayView:View {
    var music:MusicResponse
    ...
    var body: some View {
        VStack (spacing: -5){
            // progress view
            AudioProgressView(playerManager: playerManager)

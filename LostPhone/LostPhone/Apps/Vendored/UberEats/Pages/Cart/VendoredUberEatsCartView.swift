//
//  VendoredUberEatsCartView.swift
...
struct VendoredUberEatsCartView: View {
    var cartDatas:[VendoredUberEatsCartResponse] = cartData
    var body: some View {
        NavigationStack {
            ScrollView (.vertical, showsIndicators: false){
                LazyVStack (spacing:14){
                    ForEach(cartDatas) { cart in
                        VendoredUberEatsListCardRowView(cart: cart)
                    }
                }
                .padding(.horizontal)
                .padding(.vertical, 24)
...
struct VendoredUberEatsListCardRowView:View {
        ...
        VStack (spacing:12){
            ...
            HStack (spacing:16){
                ...
                Button {
                    ...
                    ZStack {
                        Circle()
                            .fill(Color.vendoredUberEatsCardColor)

//
//  VendoredAirbnbLoginViewModel.swift
//  AirbnbClone-SwiftUI
//
...
class VendoredAirbnbLoginViewModel: ObservableObject, Identifiable {
    ...
    var loginHandler = VendoredAirbnbLoginHandler()
...
extension VendoredAirbnbLoginViewModel {
    // MARK: - Validation

...
struct VendoredAirbnbLoginView: View {
    @ObservedObject var viewModel = VendoredAirbnbLoginViewModel()
    ...
    var body: some View {
        VendoredAirbnbLoadingView(isShowing: .constant(viewModel.isLoading)) {

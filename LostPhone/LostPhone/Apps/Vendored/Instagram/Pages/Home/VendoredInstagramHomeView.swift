//
//  VendoredInstagramHomeView.swift
//  Instagram clone
//
            ...
            ScrollView {
                ...
                LazyVStack {
                    ForEach(postData) { post in
                        VendoredInstagramPostView(profileImageUrl: post.user.profileImage, username: post.user.username, postImages: post.imageOrVideoUrl, caption: post.caption!, totalLikes: post.totalLikes, totalComments: post.totalComments,postType: post.postType)
                            .padding(.vertical,12)
                    }
                }
...
// profile view
struct VendoredInstagramHomeProfileViewAndStory: View {

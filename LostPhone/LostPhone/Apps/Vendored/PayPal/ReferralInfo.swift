//
//  VendoredPayPalReferralInfo.swift
//  PayPal_clone
//
...
struct VendoredPayPalReferralInfo: View {
...
struct VendoredPayPalSecondScreen: View {
...
#Preview {
    ...
    VendoredPayPalSecondScreen()
    //      VendoredPayPalReferralInfo(showReferral: .constant(true))
}

//
//  VendoredChatGPTContentView.swift
//  chatGPT
//
...
struct VendoredChatGPTContentView: View {
    @State private var prompt: String = ""
    @State private var isEditing: Bool = false
    
    @StateObject var viewModel = VendoredChatGPTChatGPTViewModel()
    ...
    var conversationView: some View {
        ScrollView {
            ForEach(viewModel.messages.indices, id: \.self) { index in
                ...
                VendoredChatGPTMessageView(isUser: isUser, messageContent: messageContent)
                }
            }
        }
    ...
    var promptField: some View {
        ZStack {
            TextField("VendoredChatGPTMessage", text: $prompt)
                .tint(.gray)
                .padding(.horizontal, 10)
                .padding(.vertical, 5)
                .overlay(
...
struct VendoredChatGPTMessageView: View {
    var isUser: Bool

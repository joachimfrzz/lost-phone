        ...
        NavigationStack {
            ScrollView {
                VStack {
                    ...
                    VendoredThreadsLogoAndProfileActionButtonsView()
                    // feeds
                    LazyVStack {
                        ForEach(postDatas) { post in
                            VendoredThreadsPostView(post: post)
                        }
                    }
                    .padding(.vertical)
                }
...
struct VendoredThreadsLogoAndProfileActionButtonsView:View {
    var body: some View {
        VStack (spacing: 18){
            // logo
            Image("logo")
            ...
            VendoredThreadsCustomDivider()
        }
    }
}

struct VendoredThreadsPostView:View {
    ...
    var body: some View {
        VStack (spacing: 12){
            ...
            .padding(.horizontal)
            // images
            NavigationLink (destination: VendoredThreadsDetailView(post: post)){
                VendoredThreadsImagesViewer(post: post)
            }
...
struct VendoredThreadsImagesViewer:View {
    var post:VendoredThreadsPostResponse
    var body: some View {
...
struct VendoredThreadsButtonOptionsView:View {
    var post:VendoredThreadsPostResponse
    var body: some View {
        HStack (spacing: 22){
            // likes

//
//  VendoredYouTubeMusicScrollableMusicRowView.swift
//  Youtube_Music_v2
//
...
struct VendoredYouTubeMusicScrollableMusicRowView: View {
...
#Preview {
    VendoredYouTubeMusicScrollableMusicRowView(music: danceAndEelectronicData[0])
}

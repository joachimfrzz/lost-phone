...
struct VendoredInstagramLandingLoginView: View {
    var body: some View {
        NavigationStack {
            VStack {
                VStack (spacing: 20){
                ...
                VStack (spacing: 30){
                    ...
                    // button
                    VStack (spacing: 12){
                        NavigationLink(destination: VendoredInstagramLoginView()) {
                            VendoredInstagramPrimaryButtonView(title: "Log in")
                        }
                        VendoredInstagramPrimaryOutlineButtonView(title: "Log into another account", action: {})
...
#Preview {
    VendoredInstagramLandingLoginView()
}

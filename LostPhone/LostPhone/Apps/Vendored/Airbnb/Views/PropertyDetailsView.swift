//
//  VendoredAirbnbPropertyDetailsView.swift
//  AirbnbClone-SwiftUI
//
...
struct VendoredAirbnbPropertyDetailsView : View {
        ...
        ScrollView(.vertical, showsIndicators: false) {
            VStack(alignment: .leading, spacing: 10) {
                ZStack(alignment: .bottom) {
                    VendoredAirbnbPageView(experiences.map { VendoredAirbnbFeaturedPropertyView(movie: $0) })
                        .frame(height: 225)
                    HStack {
...
struct PropertyDetails_Preview: PreviewProvider {
    static var previews: some View {
        VendoredAirbnbPropertyDetailsView(item: VendoredAirbnbExperiences(image: "property1", name: "Paris Best kept secrets tour", price: "2"))
    }
}

struct VendoredAirbnbFeaturedPropertyView: View {
    var movie: VendoredAirbnbExperiences
    var body: some View {
            ZStack(alignment: .bottom) {
                Image(movie.image)
                    .resizable()

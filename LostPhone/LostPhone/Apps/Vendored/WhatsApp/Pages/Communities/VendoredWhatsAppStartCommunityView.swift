//
//  VendoredWhatsAppStartCommunityView.swift
//  WhatsAppclone
//
...
struct VendoredWhatsAppStartCommunityView: View {
    ...
    var body: some View {
        NavigationStack {
                ...
                VStack (spacing: 14){
                    ...
                    .frame(height: 45)
                    .background(Color.vendoredWhatsAppVendoredWhatsAppPrimary)
            ...
            .sheet(isPresented: $showingNewCommunitySheet){
                VendoredWhatsAppNewCommunityView()
            }
...
#Preview {
    VendoredWhatsAppStartCommunityView()
}

# Snapchat — source vendored

| Champ | Valeur |
|-------|--------|
| **Repo** | sopheamenvan/Patreon:Snapchat Clone patreon.zip |
| **Licence** | Patreon (usage projet) |
| **Entrée Lost Phone** | `LpspVendoredSnapchatRootView()` → `VendoredSnapchatContentView` |

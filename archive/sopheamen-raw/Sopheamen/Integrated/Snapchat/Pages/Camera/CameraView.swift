...
struct ProfileAndOptionIconsView: View {
    var body: some View {
        HStack (alignment: .top){
            ...
            HStack (alignment: .top){
                IconButtonOpacity(iconName: "person.fill")
                // icons option
                VStack (spacing:24){
                    ...
                    Image(systemName: "music.note")
                        ...
                        .fontWeight(.bold)
                    IconButtonOpacity(iconName: "plus")

...
struct VendoredWhatsAppChatDetailView: View {
    ...
    var chatConversationResponse:[VendoredWhatsAppChatConversationResponse] = chatConversationData
                    ...
                    VStack {
                        ...
                        LazyVStack (spacing: 10){
                            ForEach(chatConversationResponse) { response in
                                VendoredWhatsAppBubbleChatView(text: response.text,isMe: response.isMe, timeAgo: response.dateTime, isReaction: response.isReaction ?? nil)
                            }
                        }
                        .padding(.vertical,20)

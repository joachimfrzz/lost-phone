//
//  VendoredUberLocationSearchViewModel.swift
//  iUber
//
...
class VendoredUberLocationSearchViewModel: NSObject, ObservableObject{
...
extension VendoredUberLocationSearchViewModel : MKLocalSearchCompleterDelegate{

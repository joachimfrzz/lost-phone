//
//  VendoredInstagramActivityView.swift
//  Instagram-SwiftUI
//
...
struct VendoredInstagramActivityView: View {
    
    let activity: VendoredInstagramActivity
...
struct VendoredInstagramLikedActivityView_Previews_Comment: PreviewProvider {
    static var previews: some View {
        VendoredInstagramActivityView(activity: VendoredInstagramActivity(activity: .comment,
                                             duration: "5h",
...
struct VendoredInstagramLikedActivityView_Previews_SuggestedFollower: PreviewProvider {
    static var previews: some View {
        VendoredInstagramActivityView(activity: VendoredInstagramActivity(activity: .suggestFollower,
                                             duration: "6h",
...
struct VendoredInstagramLikedActivityView_Previews_NewFollower: PreviewProvider {
    static var previews: some View {
        VendoredInstagramActivityView(activity: VendoredInstagramActivity(activity: .newFollower,
                                             duration: "18h",
